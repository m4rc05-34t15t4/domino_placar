<?php
    ...
    // Desliga exibição na tela
    /*ini_set('display_errors', 0);
    ini_set('display_startup_errors', 0);
    error_reporting(E_ALL); // ainda registra no log*/
    ...
    function connectToDatabase() {
        ...
        try {
            ...
            if (!$connection) {
                $erro = pg_last_error($pg_last_error);
                error_log("Erro na consulta: $erro"); // vai para o log
                echo "Erro ao executar a consulta."; // mensagem amigável para usuário
    ...
    function executeQuery($sql) {
        try {
            ...
            //echo "<script>console.log('PHP: " . "Erro na consulta SQL: " . $e->getMessage() . "');</script>";
