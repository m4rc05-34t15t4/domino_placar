...
try {
    ...
    if (!$acao || !$dataHora || !$jogador1 || !$jogador2 || !$jogador3 || !$jogador4) {
    ...
    switch ($acao) {
        case 'INSERT':
            $sql = "INSERT INTO partida ( data_hora, jogador1_id, jogador2_id, jogador3_id, jogador4_id, placar1, placar2 ) 
                VALUES ( '$dataHora', $jogador1, $jogador2, $jogador3, $jogador4, $placar1, $placar2 ) RETURNING ID;";
            break;
        case 'UPDATE':
